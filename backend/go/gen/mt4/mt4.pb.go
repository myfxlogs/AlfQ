...
const file_mt4_proto_rawDesc = "" +
	"\n" +
	"\tmt4.proto\x12\amt4grpc\x1a\x1fgoogle/protobuf/timestamp.proto\"i\n" +
	"\x05Error\x12&\n" +
	...
	"\rOnOrderProfit\x12\x1d.mt4grpc.OnOrderProfitRequest\x1a\x1b.mt4grpc.OnOrderProfitReply0\x01B$Z\"github.com/alfq/backend/go/gen/mt4b\x06proto3"

var (
	file_mt4_proto_rawDescOnce sync.Once
	file_mt4_proto_rawDescData []byte
)

func file_mt4_proto_rawDescGZIP() []byte {
	file_mt4_proto_rawDescOnce.Do(func() {
		file_mt4_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mt4_proto_rawDesc), len(file_mt4_proto_rawDesc)))
	})
...
func file_mt4_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mt4_proto_rawDesc), len(file_mt4_proto_rawDesc)),
			NumEnums:      11,
			NumMessages:   126,
			NumExtensions: 0,
			NumServices:   6,
