...
const (
	...
	HealthServiceName = "alfq.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/alfq.v1.HealthService/Check"
)

// HealthServiceClient is a client for the alfq.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the alfq.v1.HealthService service. By default, it
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_alfq_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls alfq.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the alfq.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/alfq.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("alfq.v1.HealthService.Check is not implemented"))
}
